...
public class RandomNumberMaker {
    ...
    // based on pokemon with the lowest defense stats (weedle, spearow).
    // these are their defense stat according to the api.
    // so you have a better chance of catching any pokemon
    // with the regular (1x catch rate) pokeball and a guaranteed
    // catch if you choose one of the lowest defense stat pokemon
